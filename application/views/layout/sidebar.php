  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="<?= base_url('dashboard') ?>">
        ...
        <span class="ms-1 font-weight-bold">Tracher Study STIMIK</span>
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <?php if ($this->session->userdata('role') == 1) { ?>
          ...
          <!-- Data Alumni -->
          <li class="nav-item">
            <a class="nav-link <?= ($title === "Data Alumni") ? 'active' : '' ?> " href="<?= base_url('data_alumni') ?>">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
          ...
          <a class="nav-link  " href="../pages/rtl.html">
            ...
            <span class="nav-link-text ms-1">Identitas</span>
          </a>
        </li> -->
          <!-- Management User -->
          <li class="nav-item">
        ...
        <?php } elseif ($this->session->userdata('role') == 0) { ?>
          ...
          <!-- Biodata -->
          <li class="nav-item">
            <a class="nav-link <?= ($title === "Biodata") ? 'active' : '' ?> " href="<?= base_url('biodata') ?>">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
          ...
          <?php if ($this->session->userdata('selesai') == 0) { ?>
            <!-- kosong -->
          <?php } else if ($this->session->userdata('selesai') == 1) { ?>
            <!-- Loker -->
          <li class="nav-item">
            <a class="nav-link <?= ($title === "Lowongan Pekerjaan") ? 'active' : '' ?> " href="<?= base_url('loker') ?>">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
