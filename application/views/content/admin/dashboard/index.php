    ...
    <div class="row mt-4">
        ...
        <!-- <div class="col-lg-5">
            <div class="card h-100 p-3">
                <div class="overflow-hidden position-relative border-radius-lg bg-cover h-100" style="background-image: url('http://localhost/treacherstudy//assets/img/ivancik.jpg');">
