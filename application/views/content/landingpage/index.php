                    ...
                    <div class="container-fluid pe-0">
                        ...
                        <div class="collapse navbar-collapse" id="navigation">
                            ...
                            <li class="nav-item d-flex align-items-center">
                                <a class="btn btn-round btn-sm mb-0 btn-outline-primary me-2" href="<?= base_url('login') ?>">Masuk</a>
                            </li>
                        </div>
                    </div>
                </nav>
                        ...
                        <div class="col-xl-7 col-lg-5 col-md-8 d-flex flex-column mx-auto">
                            <div class="card card-plain mt-8">
                                <div class="card-header pb-0 text-left bg-transparent">
                                    ...
                                    <p class="mb-0">Tracer Study STMIK ADHI GUNA Palu</p>
                                </div>
                                <div class="card-body">
                                    <p class="text-justify">Survey Tracer Study ini merupakan wujud tanggung jawab STMIK Adhi Guna untuk memastikan bahwa lulusan STMIK Adhi Guna terserap didunia kerja. Kami mohon untuk meluangkan waktu Melengkapi data Penelurusan Alumni (Tracer Study). Semua informasi yang diberikan hanya digunakan untuk keperluan perbaikan proses Pendidikan di STMIK Adhi Guna, berkaitan dengan kurikulum yang sesuai dengan tuntutan keahlian didunia kerja sekarang ini. </p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="oblique position-absolute top-0 h-100 d-md-block d-none me-n8">
                                <img class="w-85 position-relative z-index-2 pt-4 mt-7" src="<?= base_url() ?>assets/img/logo.png" alt="rocket">
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="d-flex flex-column h-100">
                                            <p class="mb-1 pt-2 text-bold">Informasi</p>
                        ...
                        <div class="card h-100 p-3">
                            <div class="overflow-hidden position-relative border-radius-lg bg-cover h-100">
                                ...
                                <div class="card-body position-relative z-index-1 d-flex flex-column h-100 p-3">
                                    <h5 class="text-white font-weight-bolder mb-4 pt-2">Informasi Lebih Lengkap</h5>
                                    <p class="text-white">Silahkan Kunjungi Website Resmi STMIK ADHI GUNA Palu pada halaman berikut ini.</p>
                                    <a class="text-white text-sm font-weight-bold mb-0 icon-move-right mt-auto" target="_blank" href="https://stmikadhiguna.ac.id/v4/">
                                        Read More
                                        <i class="fas fa-arrow-right text-sm ms-1" aria-hidden="true"></i>
                                    </a>
                                </div>
            ...
            <div class="modal-dialog modal-danger modal-dialog-centered modal-" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <a type="button" href="<?= base_url('login') ?>" class="btn btn-white">Ok, Masuk</a>
